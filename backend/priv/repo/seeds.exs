...
case Mix.env() do
  :dev ->
    IO.puts("Creating dummy restaurants...")
    TastemateBackend.Repo.insert!(%TastemateBackendWeb.Restaurants.Restaurant{
      address: "123 Fake St. Irvine, CA 92612",
      cuisine: "Korean",
      image_url:
        "https://s3-media0.fl.yelpcdn.com/bphoto/UvE_Gc-vE1RUO4hCeR-7eQ/300s.jpg",
